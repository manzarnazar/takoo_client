...
import IdentityDocuments from "components/store-resgistration/IdentityDocuments";
...
export const generateInitialValues = (languages, allData) => {
  const initialValues = {
    ...
    ine_image: allData?.ine_image || "",
    ine_back_image: allData?.ine_back_image || "",
    cofepris_document_image: allData?.cofepris_document_image || "",
  };
  ...
  return (
    ...
    >
      <form noValidate onSubmit={RestaurantJoinFormik.handleSubmit}>
        ...
        >
          <IdentityDocuments RestaurantJoinFormik={RestaurantJoinFormik} />
        </CustomStackFullWidth>
