...
const postData = async (storeData) => {
  ...
  let finalData = {
    ...
    pickup_zone_id: storeData?.pickup_zone_id
      ...
      : [],
    ine_image: storeData?.ine_image,
    ine_back_image: storeData?.ine_back_image,
    ...(storeData?.cofepris_document_image && {
      cofepris_document_image: storeData.cofepris_document_image,
    }),
  };
